    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row social-button-row-2">
                <div class="col-xs-3 social-button-row-offset">
                    <!--<a class="main-button color-white button-with-icon background-blue spacing-width-1 spacing-height-1" href="http://www.facebook.com/eouadmissions" style="background-image: url('icons/facebook.svg')" data-toggle="tooltip" data-placement="bottom" title="Facebook"></a>
                    <a class="main-button color-white button-with-icon background-light-blue spacing-width-1 spacing-height-1 spacing-margin-left-1" href="https://twitter.com/eoumountaineers" style="background-image: url('icons/twitter.svg')" data-toggle="tooltip" data-placement="bottom" title="Twitter"></a>
                    <a class="main-button color-white button-with-icon background-brown spacing-width-1 spacing-height-1 spacing-margin-left-1" href="http://instagram.com/monty.mountaineer" style="background-image: url('icons/instagram.svg')" data-toggle="tooltip" data-placement="bottom" title="Instagram"></a>
                    <a class="main-button color-white button-with-icon background-orange spacing-width-1 spacing-height-1 spacing-margin-left-1" href="https://www.eou.edu/feed/" style="background-image: url('icons/rss.svg')" data-toggle="tooltip" data-placement="bottom" title="RSS Feed"></a>
                    <a class="main-button color-white button-with-icon background-red spacing-width-1 spacing-height-1 spacing-margin-left-1" href="http://www.youtube.com/eouniversity" style="background-image: url('icons/youtube.svg')" data-toggle="tooltip" data-placement="bottom" title="YouTube"></a>-->
